...
if [ -f /opt/node/data/mongo/.mongodb_password_set ]; then
    exit(0)
fi

# Admin User
MONGODB_ADMIN_USER=${MONGODB_ADMIN_USER:-"root"}
MONGODB_ADMIN_PASS=${MONGODB_ADMIN_PASS:-"F60Da58_90Am10"}

# Application Database User
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"api-vuttr"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"sysdba"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-'S76%$00_dba'}
